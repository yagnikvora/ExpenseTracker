        ...
        <div className="row">
          ...
          {/* <div className="col-lg-2 col-md-4 mb-3 mb-md-0 offset-5">
            ...
            <ul className="list-unstyled">
              ...
              <li><Link to="/transactions" className="text-muted text-decoration-none">Transactions</Link></li>
              <li><Link to="/reports" className="text-muted text-decoration-none">Reports</Link></li>
